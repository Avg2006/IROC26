...
class droneControl(Node):
    def __init__(self):
        ...
        #     (0.121869,  0.992546, 2.0),
        #     (0.243738,  1.985092, 2.0),
        #     (0.365607,  2.977638, 2.0),
        #     (0.487476,  3.970184, 2.0),
        #     (0.609345,  4.962730, 2.0),
        #     (0.731214,  5.955276, 2.0),
        #     (1.723760,  5.833407, 2.0),
        #     (1.601891,  4.840861, 2.0),
        #     (1.480022,  3.848315, 2.0),
        #     (1.358153,  2.855769, 2.0),
        #     (1.236284,  1.863223, 2.0),
        #     (1.114415,  0.870677, 2.0),
        #     (0.992546, -0.121869, 2.0),
        #     (1.985092, -0.243738, 2.0),   #  8  back to centre
        #     (2.106961,  0.748808, 2.0),   #  9
        #     (2.228830,  1.741354, 2.0),   # 10
        #     (2.350699,  2.733900, 2.0),
        #     (2.472568,  3.726446, 2.0),
        #     (2.594437,  4.718992, 2.0),
        #     (2.716306,  5.711538, 2.0),
        #     (3.708852,  5.589669, 2.0),
        #     (3.586983,  4.597123, 2.0),
        #     (3.465114,  3.604577, 2.0),
        #     (3.343245,  2.612031, 2.0),
        #     (3.221376,  1.619485, 2.0),
        #     (3.099507,  0.626939, 2.0),
        #     (2.977638, -0.365607, 2.0),
        #     (0.000000,  0.000000, 1.5),   # 16 ← LAST WAYPOINT — return home / ArUco search
        # ]
        ...
        self.waypoints = [
            ...
            (0.243738,  1.985092, 2.0),
            (0.365607,  2.977638, 2.0),
            (-0.626939, 3.099507, 2.0),
            (-0.748808, 2.106961, 2.0),
            (-0.870677, 1.114415, 2.0),
            (-0.992546, 0.121869, 2.0),
            (-1.985092, 0.243738, 2.0),
            (-1.863223, 1.236284, 2.0),
            (-1.741354, 2.228830, 2.0),
            (-1.619485, 3.221376, 2.0),
            (-2.612031, 3.343245, 2.0),
            (-2.733900, 2.350699, 2.0),
            (-2.855769, 1.358153, 2.0),
            (-2.977638, 0.365607, 2.0),
            (-3.970184, 0.487476, 2.0),
            (-3.848315, 1.480022, 2.0),
            (-3.726446, 2.472568, 2.0),
            (-3.604577, 3.465114, 2.0),
            (-4.597123, 3.586983, 2.0),
            (-4.718992, 2.594437, 2.0),
            (-4.840861, 1.601891, 2.0),
            (-4.962730, 0.609345, 2.0),
            (-5.955276, 0.731214, 2.0),
            (-5.83, 2.085, 2.0),
            (-5.711538, 2.716306, 2.0),
            (-5.589669, 3.708852, 2.0),
            (0.000000,  0.000000, 1.5),
        ]
