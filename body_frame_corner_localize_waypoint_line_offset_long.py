...
class WaypointFullMission(Node):
    def __init__(self):
        ...
        self.mission_body_waypoints = [
            ...
            (-6.0, -0.0, self.takeoff_alt),
            (-7.0, -0.0, self.takeoff_alt),
            (-8.0, -0.0, self.takeoff_alt),
            (-8.0, -1.0, self.takeoff_alt),
            (-7.0, -1.0, self.takeoff_alt),
            (-6.0, -1.0, self.takeoff_alt),
            ...
            (-6.0, -2.0, self.takeoff_alt),
            (-7.0, -2.0, self.takeoff_alt),
            (-8.0, -2.0, self.takeoff_alt),
            (-8.0, -3.0, self.takeoff_alt),
            (-7.0, -3.0, self.takeoff_alt),
            (-6.0, -3.0, self.takeoff_alt),
            ...
            (-6.0, -4.0, self.takeoff_alt),
            (-7.0, -4.0, self.takeoff_alt),
            (-8.0, -4.0, self.takeoff_alt)
        ]
        # ──────────────────────────────────────────────────────────────
